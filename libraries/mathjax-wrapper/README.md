# @doonce/mathjax-wrapper

> A package that wrapps MathJax and includes lazy load feature
...
├── mathjax-wrapper.build.log              # 构建日志
...
│   ├── mathjax-wrapper.api.json
│   └── mathjax-wrapper.api.md
├── package.json
├── src
