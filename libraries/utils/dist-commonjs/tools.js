...
exports.makePromiseTimeoutAutoCancel =
  exports.thousands =
  exports.getGlobalThis =
  exports.getOrigin =
  exports.uuid =
  exports.getImgURLBlob =
  exports.replaceEmoji =
  exports.flattenDeep =
  exports.flatten =
  exports.num2percentage =
  exports.fixedDecimal =
  exports.ms2hms =
  exports.ms2PrimeSymbol =
  exports.padZero =
  exports.ms2h =
  exports.ms2m =
  exports.ms2s =
  exports.str2kebab =
  exports.eventListenerPassiveSupported =
  exports.dateFormat =
  exports.chunk =
  exports.timeChunk =
  exports.throttle =
 ...
 */
const eventListenerPassiveSupported = () => {
  if (typeof exports.eventListenerPassiveSupported.isSupportPassive === 'boolean') {
    return exports.eventListenerPassiveSupported.isSupportPassive
  }
  ...
  exports.eventListenerPassiveSupported.isSupportPassive = isSupportPassive
  return isSupportPassive
}
exports.eventListenerPassiveSupported = eventListenerPassiveSupported
/**
 * 驼峰、帕斯卡转烤串
...
exports.ms2PrimeSymbol = ms2PrimeSymbol
/**
 * 毫秒转换为 时'分"秒 形式
 * @param {Number|String} num 需要转换的数字
 ...
 * @param {Boolean} showM 是否需要展示分；默认为true
 */
function ms2hms({ num, sep = "'", subSep = '"', needPadZero = true, showH = true, showM = true }) {
  const n = Math.floor(num)
  // null 会被floor函数转为0
 ...
 */
function fixedDecimal(originalNum, keepCount = 1, round = true, keepNegativeZero = false) {
 ...
 */
function num2percentage(originalNum) {
  const num = parseFloat(originalNum)
  if (isNaN(num) || num > 1 || num < 0) return originalNum
  return num * 100
}
exports.num2percentage = num2percentage
/**
 * 扁平化
 *
 ...
 */
const replaceEmoji = (str, placeholder = '') =>
  typeof str === 'string'
    ? str.replace(
        /(?:[\u2700-\u27bf]|(?:\ud83c[\udde6-\uddff]){2}|[\ud800-\udbff][\udc00-\udfff]|[\u0023-\u0039]\ufe0f?\u20e3|\u3299|\u3297|\u303d|\u3030|\u24c2|\ud83c[\udd70-\udd71]|\ud83c[\udd7e-\udd7f]|\ud83c\udd8e|\ud83c[\udd91-\udd9a]|\ud83c[\udde6-\uddff]|\ud83c[\ude01-\ude02]|\ud83c\ude1a|\ud83c\ude2f|\ud83c[\ude32-\ude3a]|\ud83c[\ude50-\ude51]|\u203c|\u2049|[\u25aa-\u25ab]|\u25b6|\u25c0|[\u25fb-\u25fe]|\u00a9|\u00ae|\u2122|\u2139|\ud83c\udc04|[\u2600-\u26FF]|\u2b05|\u2b06|\u2b07|\u2b1b|\u2b1c|\u2b50|\u2b55|\u231a|\u231b|\u2328|\u23cf|[\u23e9-\u23f3]|[\u23f8-\u23fa]|\ud83c\udccf|\u2934|\u2935|[\u2190-\u21ff])/g,
        placeholder
...
exports.getImgURLBlob = getImgURLBlob
/**
 * 生成唯一id uuid v4版本
 ...
 * 1000.123 -> 1,000.123
 */
const thousands = num => num.toString().replace(/(\d{1,3})(?=(\d{3})+(?:$|\.))/g, '$1,')
 ...
 */
function makePromiseTimeoutAutoCancel(oneOrMorePromise, timeout, msg = 'timeout') {
...
exports.makePromiseTimeoutAutoCancel = makePromiseTimeoutAutoCancel
