 ...
 */
export function measureImgSize(src) {
...
export const canSupportCssVar = () => {
    if (canSupportCssVar.isSupport != null)
        return canSupportCssVar.isSupport;
 ...
 */
export function genSvgText({ width = 300, height = 150, fontSize = 14, fontFamily = 'system-ui, sans-serif', color = '#a2a9b6', opacity = 1, x = 50, y = 50, content = 'svg测试文本', rotate = 0 } = {}) {
...
export function watermarkSvg(params = {}) {
    return makeSvgInline(genSvgText({
        rotate: -45,
        width: 200,
        height: 200,
        opacity: 0.5,
...
export function loadJs(src, options = { type: 'text/javascript' }) {
    return new Promise((resolve, reject) => {
        if (typeof src !== 'string')
            return reject('must specify src(string)');
